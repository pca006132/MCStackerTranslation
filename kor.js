...
llArrowLife="생명";
ttArrowLife="화살이 정지된 상태에서 틱마다 증가하며 1200에 도달하면 화살이 디스폰됩니다. 화살이 이동하면 0으로 초기화됩니다.";
llArrowDamage="대미지";
ttArrowDamage="화살이 입히는 대미지로, 수치당 반 하트입니다.";
llExplosionPower="폭발력";
ttExplosionPower="화염구 착탄시의 폭발 범위와 위력입니다. 기본값은 1입니다.";
llOwnerName="주인 이름";
ttOwnerName="이 발사체를 쏜 플레이어의 이름.";
llPotionAppearance="포션";
...
llShowArms="팔 보이기";
ttShowArms="나무 팔을 갑옷 거치대에 표시합니다.";
llSmall="소형";
ttSmall="아기 좀비 크기의 갑옷 거치대.";
llMarker="마커";
ttMarker="갑옷 거치대의 사이즈가 0으로 설정되어 보이지 않게 되며 매우 작은 히트 박스를 갖게 됩니다.";
llInvisible="투명";
ttInvisible="갑옷 거치대가 투명해집니다. 하지만 장착된 아이템들은 투명해지지 않습니다.";
llNoBasePlate="밑판 제거";
ttNoBasePlate="갑옷 거치내 밑의 밑판을 표시하지 않습니다.";
llNoGravity="무중력";
ttNoGravity="체크할 경우 갑옷 거치대를 공중에 소환해도 떨어지지 않습니다.";
llBaseRotation="전체 회전";
ttBaseRotation="갑옷 거치대 전체의 회전 각도.";
llPersistence="지속성";
...
ttChickenJockey="닭이 아기 좀비의 탑승물인지 여부. 체크하면 닭이 자연적으로 디스폰될 수 있게 됩니다. 다른 효과는 불명. 설령 체크하지 않아도 아기 좀비가 닭을 조종하는 데에는 지장이 없습니다.";
llPowered="충전";
ttPowered="크리퍼가 번개에 맞아 충전 됬는지 여부. 크리퍼 주변에 푸른 아우라가 생깁니다. 충전된 크리퍼는 더 큰 폭발 반경을 갖고 있습니다. 하지만 이는 폭발 반경 설정으로 덮어씌울 수 있습니다.";
llIgnited="점화";
ttIgnited="크리퍼가 라이터에 의해 점화되었다면 체크하세요.";
llExplosionRadius="폭발 반경";
ttExplosionRadius="폭발 반경. 기본값은 3입니다.";
llFuse="도화선";
...
llCarried="운반";
ttCarried="엔더맨이 운반 중인 아이템.";
llLifeTime="수명";
ttLifeTime="엔더 진드기가 사라질 때까지의 틱. 2400에 도달하면 사라집니다.";

llBlock="블록";
ttBlock="떨어지는 블록.";
llTileEntityData="타일 엔티티 데이터";
ttTileEntityData="선택 사항. 이 블럭의 타일 엔티티 태그.";
llTime="시간";
